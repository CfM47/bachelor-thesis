\begin{conclusionsAndRecomendations}
    ...
    Además de definir el lenguaje $\satlang(F)$ se propuso una manera de construirlo mediante la intersección de una autómata finito determinista con el lenguaje $\repeatlang$. Esta construcción implica que para cualquier formalismo que genere el lenguaje $\repeatlang$ y sea cerrado bajo intersección con lenguajes regulares, se tiene que construir esta intersección o el problema del vacío son problemas NP-duros. Esto, tomando como cierta la conjetura de que cualquier formalismo que genere $\repeatlang$ tiene tamaño $O(1)$ en su representación.
