...
\begin{definition}{(Problema de satisfacibilidad booleana)}
	Sea $F$ una fórmula booleana en CNF, el problema de satisfacibilidad booleana consiste en determinar si existe una interpretación $v$ para las variables de $F$ tal que $(F)_v = 1$.
\end{definition}
