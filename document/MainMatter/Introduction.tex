...
En el capítulo \ref{ch:w-plus} se muestra cómo construir el lenguaje $\repeatlang$ utilizando pMCFG y se analiza la complejidad computacional de esta construcción. Se demuestra que si para toda fórmula booleana, existe una pMCFG que describe el lenguaje de sus interpretaciones verdaderas entonces no existe un algoritmo polinomial para decidir si esta es vacía a menos que P=NP.
