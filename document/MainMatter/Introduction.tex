...
\begin{itemize}
    ...
    \item Demostrar que no es posible describir el lenguaje de las interpretaciones que satisfacen una fórmula booleana por una pMCFG, a menos que P=NP.
\end{itemize}
